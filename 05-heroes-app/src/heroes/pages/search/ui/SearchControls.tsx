            ...
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        className="h-12"
                        onClick={() => setQueryParams("active-accordion", activeAccordion === "advance-filters" ? "" : "advance-filters")}
                    >
                        ...
                        <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">All teams</div>
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="mt-4">
                                ...
                                <Slider defaultValue={[selectedStrength]} step={1} max={10} onValueChange={(value) => setQueryParams('strength', value[0].toString())} />
                            </div>
                        </div>
                    </AccordionContent>
                </AccordionItem>
