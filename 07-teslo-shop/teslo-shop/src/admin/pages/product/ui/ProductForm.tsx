...
export const ProductForm = ({ isPending, title, subTitle, product, onSubmit }: Props) => {
    ...
    const addTag = () => {
        ...
        const newTag = inputTagRef.current?.value.trim().toLowerCase() || '';
        ...
        setValue('tags', Array.from(newTagsSet), { shouldDirty: true });
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        ...register('slug', {
                                            required: true,
                                            validate: (value) => {
                                                return !/\s/.test(value) || "El slug no puede contener espacios"
                                            }
                                        })
                                        }
                                    />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        ...register('description', {
                                            ...
                                            minLength: { value: 1, message: "La descripción es requerida" }
                                        })
                                        }
                                    />
                                    {
                                ...
                                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-200">
                                    ...
                                    {availableSizes.map((size) => (
                                        <button
                                            ...
                                            className={`cursor-pointer px-3 py-1 rounded-full text-sm font-medium transition-all duration-200 ${selectedSizes.includes(size)
